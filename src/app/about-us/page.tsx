  ...
  return (
    <>
      ...
      >
        ...
        {/* Team Section */}
          <h1 className="font-bold text-1xl  md:text-xl mb-2 ">
           <span className='text-gray-500'>Emerge</span>  <span className="text-sky-500">Family</span>
          </h1>
        ...
        <p className="w-full sm:w-[90%] md:w-[80%] mt-3 text-center text-gray-500 leading-relaxed text-sm sm:text-base md:text-lg mb-10">
          Founded on  June 21 2020, Emerge is a vibrant community of poets, writers, and creative
